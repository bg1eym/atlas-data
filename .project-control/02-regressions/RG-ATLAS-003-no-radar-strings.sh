#!/usr/bin/env bash
# RG-ATLAS-003: No forbidden radar strings (extends RG-ATLAS-001 with ACTION_RADAR).
...
echo "RG-ATLAS-003 PASS: No forbidden radar strings"
exit 0
