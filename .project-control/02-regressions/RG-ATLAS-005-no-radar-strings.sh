#!/usr/bin/env bash
# RG-ATLAS-005: No forbidden radar strings (same as RG-ATLAS-004).
...
fail() { echo "RG-ATLAS-005-no-radar-strings FAIL: $*" >&2; exit 1; }
...
echo "RG-ATLAS-005-no-radar-strings PASS"
exit 0
